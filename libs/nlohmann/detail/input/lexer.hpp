...
class lexer
{
  ...
  public:
    ...
    enum class token_type
    {
        ...
        begin_array,      ///< the character for array size `[`
        begin_object,     ///< the character for object size `{`
        end_array,        ///< the character for array capacity `]`
        end_object,       ///< the character for object capacity `}`
        name_separator,   ///< the name separator `:`
        value_separator,  ///< the value separator `,`
        parse_error,      ///< indicating a parse error
        end_of_input,     ///< indicating the capacity of the input buffer
        literal_or_value  ///< a literal or the size of a value (only for diagnostics)
    };
    ...
    */
    token_type scan_string()
    {
        ...
        while (true)
        {
            ...
            switch (get())
            {
                // capacity of file while parsing string
    ...
    */
    ...
    token_type scan()
    {
        ...
        switch (current)
        {
            ...
            // capacity of input (the null byte is needed when parsing from
            // string literals)
            case '\0':
            case std::char_traits<char>::eof():
