...
public:
    ...
    //! Set item to point to kth element.  Return true if at capacity of queue or item is marked valid; false otherwise.
...
void concurrent_queue_iterator_base_v3<Value>::advance() {
    __TBB_ASSERT( my_item, "attempt to increment iterator past capacity of queue" );
    size_t k = my_rep->head_counter;
