...
#endif
        {
            ...
            public:
                ...
                segmented_iterator(const segmented_iterator<SegmentedContainer, U>& other) :
                    ...
                    // can we assign a default-constructed iterator to inner if we're at the capacity?
                ...
                // the capacity of the outer container is reached.
                ...
                reference operator*() const {
                    __TBB_ASSERT(my_segcont != NULL, NULL);
                    __TBB_ASSERT(outer_iter != my_segcont->end(), "Dereferencing a pointer at capacity of container");
